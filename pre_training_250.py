...
train_audio_path = '/media/brlee/data3/.deep-speaker-wd/LibriSpeech/train-clean-100'
all_wave = []
all_label = []
...
def main():
    ...
    mc = ModelCheckpoint('pre_training_250.hdf5', monitor='val_accuracy', verbose=1, save_best_only=True, mode='max')

    start = datetime.datetime.now()
    history = model.fit(x_tr, y_tr, epochs=100, callbacks=[es, mc], batch_size=4, validation_data=(x_val, y_val))
